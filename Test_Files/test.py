...
def main():
    ...
    # -------------
    d1=100; d2=500; d3=100
    print(f'Creating rules-based file for test4 ({d1}x{d2}x{d3})')
    test4(d1,d2,d3,"test4_rules.h5")
    print(f'Creating starndard file for test4 ({d1}x{d2}x{d3}: {(d1*d2*d3*8)/(1024*1024):5.2f} MB)')
